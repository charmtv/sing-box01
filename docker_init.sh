...
WORK_DIR=/sing-box
PORT=$START_PORT
SUBSCRIBE_TEMPLATE="https://raw.githubusercontent.com/milier-rice/client-templates/main"
...
check_latest_sing-box() {
  # 检查是否强制指定版本
  local FORCE_VERSION=$(wget --no-check-certificate --tries=2 --timeout=3 -qO- https://raw.githubusercontent.com/milier-rice/sing-box-family/refs/heads/main/force_version | sed 's/^[vV]//g')
